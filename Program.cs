...
namespace BarrioShopManager
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(
                usuario == usuarioDefecto && clave == claveDefecto
